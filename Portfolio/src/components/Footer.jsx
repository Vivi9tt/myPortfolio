function Footer() {
  return (
    <div className="footer border-t">
      <div className="flex flex-col items-center md:flex-row md:justify-between max-w-screen-xl mx-auto px-16 py-8 w-full">
        ...
        <div className="text-center md:text-right mt-4 md:mt-0">
          <div className="flex gap-1 items-center justify-center md:justify-end">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" height="16px" width="16px" version="1.1" id="Capa_1" viewBox="0 0 367.467 367.467" xml:space="preserve">
                <g>
          ...
          <p>Designed and developed by Vivian Chen</p>
        </div>
      </div>
    </div>
  );
